...
public class CorrectionAnalysis {
    ...
    @AfterReturning(returning = "result", pointcut = "execution(* org.guge.coursebackend.service.TaskService.correctTask(..)) && args(correction, email)", argNames = "result,correction,email")
